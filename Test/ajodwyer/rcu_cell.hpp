...
// DANGER! This class can hold an RCU reader lock forever! Do not use it!
...
namespace detail {
    ...
    struct cell_control_block : std::rcu::enable_retire_on_this<cell_control_block<T, Alloc>, cell_control_block_deleter<cell_control_block<T, Alloc>>> {
